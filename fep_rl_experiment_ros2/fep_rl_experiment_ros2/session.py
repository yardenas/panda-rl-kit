...
from fep_rl_experiment_ros2.logger import Logger
from fep_rl_experiment_ros2.plot import RewardPlotter
...
class Session:
    ...
    def __init__(
        ...
        """
        self.logger = Logger(
            directory=directory, filename_prefix=filename_prefix, filename=filename, logger=logger
        )
